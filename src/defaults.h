...
#define PMLX FPT(2000.0) // 100.0
#define PMLSTRENGTH FPT(0.4) // 0.1
#define SHIFTGRANULARITY 1  // NOTE: shift is counted in blocks
#define HYDROZSRC FPT(0.0)
#define HYDROXSRC FPT(0.0)
#define MAINSRC	FPT(1.0)
#define PRESSURESRC	FPT(1.0)
#define HSRC	FPT(1.0)
#define IFNONLIN	FPT(1.0)
